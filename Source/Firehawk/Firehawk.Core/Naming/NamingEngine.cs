    ...
    internal class NamingEngine : INamingEngine
    {
        ...
        public string ToComponentColumnName(MemberInfo property, MemberInfo parentProperty)
        {
            ...
            switch (namingConventions.ComponentsColumnsNamingConvention)
            {
                ...
                case ComponentsColumnsNamingConvention.ComponentName_PropertyName: result = string.Format(Resources.ConventionFormats.RelationshipUnderscoreSeparated, ToColumnName(property.DeclaringType.Name), ToColumnName(property.Name)); break;
                ...
                case ComponentsColumnsNamingConvention.EntityPropertyName_ComponentPropertyName: result = string.Format(Resources.ConventionFormats.RelationshipUnderscoreSeparated, ToColumnName(parentProperty.Name), ToColumnName(property.Name)); break;
        ...
        public string ToComponentForeignKeyColumnName(MemberInfo property, MemberInfo parentProperty, MemberInfo idProperty)
        {
            ...
            switch (namingConventions.ComponentsColumnsNamingConvention)
            {
                ...
                case ComponentsColumnsNamingConvention.ComponentName_PropertyName: result = string.Format(Resources.ConventionFormats.RelationshipUnderscoreSeparated, ToColumnName(property.DeclaringType.Name), ToColumnName(columnName)); break;
                ...
                case ComponentsColumnsNamingConvention.EntityPropertyName_ComponentPropertyName: result = string.Format(Resources.ConventionFormats.RelationshipUnderscoreSeparated, ToColumnName(parentProperty.Name), ToColumnName(columnName)); break;
                case ComponentsColumnsNamingConvention.Custom:
                    {
                        if (namingConventions.ComponentsColumnsCustomNamingConvention == null)
                            throw new ConfigurationErrorsException(string.Format(ExceptionMessages.CustomConventionNotFound, typeof(ComponentsColumnsNamingConvention).Name));
